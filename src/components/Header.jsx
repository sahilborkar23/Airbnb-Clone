...
const Header = () => {
  return (
    <header className="border-b border-gray-200">
      <div className="w-full px-6 md:px-10 lg:px-12 h-20 md:h-22 flex items-center justify-between">

        {/* Logo */}
        <div className="hidden md:flex flex-1 items-center">
          <a
            href="#"
            className="ml-8 text-[#FF385C] flex items-center gap-2 font-bold text-xl tracking-tighter"
          >
            <svg width="102" height="32" viewBox="0 0 3490 1080" style={{ display: 'block', fill: 'currentColor' }}>
        ...
        <div className="md:hidden flex-1 flex justify-center py-2">
          <div className="flex w-full items-center border border-gray-300 rounded-full h-[52px] px-4 shadow-[0_3px_10px_rgba(0,0,0,0.1)] bg-white cursor-pointer">
            <Search size={20} className="text-[#222222] mr-3 stroke-2" />
            <div className="flex flex-col justify-center">
              <span className="text-[14px] font-semibold text-[#222222] leading-tight">Where to?</span>
              <span className="text-[12px] text-[#717171] leading-tight mt-0.5">Anywhere • Any week • Add guests</span>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-1 justify-end items-center gap-1">
          ...
          <button className="w-11 h-11 flex items-center justify-center rounded-full bg-[#F7F7F7] hover:bg-gray-200 transition cursor-pointer">
